...
/* ── Segredo da sessão ──
 * SESSION_SECRET é obrigatório — antes deste patch havia fallback hardcoded
 * (`'sigma-internal-secret-2024'`) que tornava tokens forjáveis em qualquer
 * deploy sem env setada. Agora o app falha o startup se ausente. */
