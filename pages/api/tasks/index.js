...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'POST') {
      const { title, description, client_id, assigned_to, priority, due_date, due_time, status, category_id, estimated_hours, subtasks, subtasks_required, dependsOn } = req.body;
      if (!title) {
